...
class Comment extends Component {
    ...
    onChangeRating = ( item,newValue ) => {
        const comment = {...item, rating:newValue};
        ...
        return (
            <div className="main_block">
                        ...
                        return (
                            <div className={this.colorForReating(el.rating)} key={`comment_${index}`}>
                                ...
                                <div className="rating_side">
                                        ...
                                        <p>{el.rating}</p>
                                        <CommentReplaceModal 
                                                replase={this.replase}
                                                method={this.props.method} data={el}/>
                                </div>
                            </div>
                        )
                    })
                ...
                <div className="add_comment">
                    <input type="email" className="input_text" 
                        placeholder="Write your email"
                        value={ emails[index] === undefined ? "" : emails[index] }   
                        onChange={ (e) => this.handleChange(e.target.value,"emails",index) } 
                        disabled={disableRating} />
                    ...
                    <input type="text"   
                        ...
                        value={names[index] === undefined ? "" : names[index]}  
                        onChange={(e) => this.handleChange(e.target.value,"names",index) }
                        disabled={disableRating}/>

                    <Button variant="outlined" 
                        color="primary" 
                        onClick={()=>  this.sendComment(index,emails[index], bodies[index], names[index]) } >
                            Add Comment
                    </Button>
